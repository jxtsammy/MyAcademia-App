    ...
    <SafeAreaView style={styles.safeAreaContainer}>
      <View style={styles.container} {...panResponder.panHandlers}>
        ...
        <View style={styles.illustrationContainer}>
          <Image
            source={require('../../assets/RegisterIntro.png')}
            style={styles.illustration}
            resizeMode="contain"
          />
        </View>
        <Text style={styles.title}>Get Signed Up</Text>
        <Text style={styles.subtitle}>
          Sign up and explore new features in our personal Academic assistant app to help you with your academic activities.
        </Text>
